...
# Submit array job
submitCommand = "aws --profile spacetx-admin batch submit-job --cli-input-json file://aws-batch-job/submit-array-job.json"
...
# Submit merge job
submitCommand = "aws --profile spacetx-admin batch submit-job --cli-input-json file://aws-merge-results-job/submit-merge-job.json"
process = subprocess.Popen(submitCommand.split(), stdout=subprocess.PIPE)
output, error = process.communicate()
submit_info = json.loads(output)
